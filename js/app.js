...
function prepareTestprep(d) {
    ...
    for (var i = 0; i < postId.length; i++) {
        ...
        if(userPosts[postId[i]].proCateg == "Mobile Phones"){
            renderTestprep(price, description, location, image, pid)
        }
    }
}

function renderTestprep(price, description, location, image, pid){
    var productContainer = document.getElementById('productContainer')
    var product = `<div class="col-3 my-3">
        <div class="card" style="width: 18rem;">
            <img class="card-img-top product_image" src=${image}>
...
function prepareHighed(d) {
    ...
    for (var i = 0; i < postId.length; i++) {
        ...
        if(userPosts[postId[i]].proCateg == "Cars"){
            renderHighed(price, description, location, image, pid)
        }
    }
}

function renderHighed(price, description, location, image, pid){
    var productContainer = document.getElementById('productContainer')
    var product = `<div class="col-3 my-3">
        <div class="card" style="width: 18rem;">
            <img class="card-img-top product_image" src=${image}>
...
function prepareFiction(d) {
    ...
    for (var i = 0; i < postId.length; i++) {
        ...
        if(userPosts[postId[i]].proCateg == "Motorcycles"){
            renderFiction(price, description, location, image, pid)
        }
    }
}

function renderFiction(price, description, location, image, pid){
    var productContainer = document.getElementById('productContainer')
    var product = `<div class="col-3 my-3">
        <div class="card" style="width: 18rem;">
            <img class="card-img-top product_image" src=${image}>
